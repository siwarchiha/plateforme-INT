jQuery(function() {
    ...
    var fbOptions = {
        disabledFieldButtons: {
            textarea: ['copy','edit','remove'], 

            text: ['copy','edit','remove'], 

            select: ['copy','edit','remove'], 
           
            date: ['copy','edit','remove'], 

            header:['copy','edit','remove'],
 
            paragraph:['copy','edit','remove'], 
           
            number:['copy','edit','remove'],

            date:['copy','edit','remove'],

            autocomplete:['copy','edit','remove'],

            file:['copy','edit','remove'],
           
            hidden:['copy','edit','remove'],
