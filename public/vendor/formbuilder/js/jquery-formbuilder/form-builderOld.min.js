...
! function(e) {
	...
	! function(e) {
			...
			T = function(t, r) {
				Array.isArray(t) || (t = [t]), t.forEach((function(t) {
					var n = "href",
						o = t,
						i = "";
					if("object" == typeof t && (n = t.type || (t.style ? "inline" : "href"), i = t.id, t = "inline" == n ? t.style : t.href, o = i || t.href || t.style), !S(o, "css")) {
						if("href" == n) {
		...
		var l = function(e) {
			...
			return r = e, (t = u).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, u.register = function(e, t) {
				...
				for(o = a ? o : o[Symbol.iterator]();;) {
					...
					var d = c.subtype || f;
					if(!e[f]) {
						var p = n.a.getClass(f, c.subtype);
						if(!p) {
						...
						d = c.datatype ? c.datatype : f + "-" + Math.floor(9e3 * Math.random() + 1e3), u.customRegister[d] = jQuery.extend(c, {
							type: f,
							class: p
						})
					}
					u.def.i18n[r][d] = c.label, u.def.icon[d] = c.icon
				}
		...
		function p(e, t) {
			for(var r = 0; r < e.length; r++) {
				...
				if(o) {
					...
					var l = [];
					for(a = 0; a < n.parts.length; a++) l.push(y(n.parts[a], t));
					i[n.id] = {
						id: n.id,
						refs: 1,
						parts: l
		...
		function y(e, t) {
			...
			if(t.singleton) {
				var a = c++;
				r = u || (u = g(t)), n = A.bind(null, r, a, !1), o = A.bind(null, r, a, !0)
			...
			}(t), n = j.bind(null, r, t), o = function() {
				h(r), r.href && URL.revokeObjectURL(r.href)
			}) : (r = g(t), n = O.bind(null, r), o = function() {
				h(r)
			});
			return n(e),
				function(t) {
		...
		function j(e, t, r) {
			...
			(t.convertToAbsoluteUrls || i) && (n = d(n)), o && (n += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");
			var a = new Blob([n], {
					type: "text/css"
				}),
				l = e.href;
				...
				if((u.multiple || "checkbox-group" === i) && (u.name = u.name + "[]"), "checkbox-group" === i && u.required && (this.onRender = this.groupRequired), delete u.title, r) {
					...
					for(var d = 0; d < r.length; d++) {
						...
						var b = m,
							...
							g = void 0 === h ? "" : h,
							v = p(b, ["label"]);
						if(v.id = u.id + "-" + d, v.selected && !o || delete v.selected, void 0 !== n && v.value === n && (v.selected = !0), f) {
							var y = this.markup("option", document.createTextNode(g), v);
							e.push(y)
						} else {
							var w = [g],
								x = "formbuilder-" + c;
							a && (x += "-inline"), v.type = c, v.selected && (v.checked = "checked", delete v.selected);
							var A = this.markup("input", null, Object.assign({}, u, v)),
								O = {
									for: v.id
								},
								j = [A, this.markup("label", w, O)];
							s && (O.className = "kc-toggle", w.unshift(A, this.markup("span")), j = this.markup("label", w, O));
					...
					if(!f && l) {
						...
						var N = {
							...
							L = this.markup("input", null, E),
							S = [document.createTextNode("Other"), this.markup("input", null, N)],
							T = this.markup("label", S, {
								for: E.id
							}),
							D = this.markup("div", [L, T], {
								className: C
							});
						e.push(D)
					}
				...
				return r.startMoving = function(e, t) {
					...
					return 0 !== t.childNodes.length && Object(p.i)(t.childNodes, (function(t, i) {
						...
						if(!a.hasClass("disabled-field")) {
							...
							if(u.length && (l.role = u.join(",")), l.className = l.className || l.class, l.className) {
								...
								b && (l.style = b[1])
							}(l = Object(p.z)(l)).type && l.type.match(n.optionFieldsRegEx) && (l.values = o.fieldOptionData(a)), r.push(l)
						}
					})), r
					...
					if(!n.includes("input-control")) {
						...
						i.match(r.optionFieldsRegEx) && (s.values = [], s.multiple = e('[name="multiple"]', o).is(":checked"), e(".sortable-options li", o).each((function(t, r) {
							...
							s.values.push(n)
						}))), (s = Object(p.z)(s, !0)).className = this.classNames(o, s), t.data("fieldData", s);
				...
				return t.init = function() {
					...
					for(var o = 0; o < r.length; o++) {
						...
						var s = a.icon || l.icon(i),
							u = a.label || l.label(i),
							c = s ? "" : a.iconClassName || "icon-" + i.replace(/-[\d]{4}$/, "");
						s && (u = '<span class="control-icon">' + s + "</span>" + u);
						var f = Object(p.p)("li", Object(p.p)("span", u), {
							className: c + " input-control input-control-" + o
						});
						f.dataset.type = i, this.controlList.push(i), this.allControls[i] = f
					}
					...
					return window.sessionStorage && (r.sortableControls ? t = window.sessionStorage.getItem("fieldOrder") : window.sessionStorage.removeItem("fieldOrder")), t ? (t = window.JSON.parse(t), t = Object(p.A)(t.concat(e)), t = Object.keys(t).map((function(e) {
						return t[e]
					}))) : t = Object(p.A)(n), t.forEach((function(e) {
		...
		var O = function(e, t, r) {
				...
				var g = new e.layout(e.layoutTemplates, !0),
					O = new v(u, g, o),
					j = p.p;
				e = O.processOptions(e), b.layout = O.editorLayout(e.controlPosition), O.editorUI(u), b.formID = u, b.lastID = b.formID + "-fld-0";
				var k = new y(e, h),
					q = m.a.subtypes = O.processSubtypes(e.subtypes),
					C = r(h.stage),
					E = r(h.controls);
				C.sortable({
					cursor: "move",
					...
					beforeStop: function(e, t) {
						return O.beforeStop.call(O, e, t)
					},
					start: function(e, t) {
						return O.startMoving.call(O, e, t)
					},
					stop: function(e, t) {
						return O.stopMoving.call(O, e, t)
					},
					...
					distance: 3,
					update: function(t, r) {
						if(O.doCancel) return !1;
						r.item.parent()[0] === h.stage ? (O.doCancel = !0, N(r.item)) : (O.setFieldOrder(E), O.doCancel = !e.sortableControls)
					}
				});
				var N = function(t) {
						if(t[0].classList.contains("input-set-control")) {
							...
							r.push.apply(r, n.fields), r.forEach((function(e) {
								T(e, !0), (O.stopIndex || 0 === O.stopIndex) && O.stopIndex++
							}))
						} else T(t, !0)
					},
					L = r(h.editorWrap),
				...
				e.showActionButtons && S.appendChild(h.formActions), L.append(h.stage, S), "textarea" !== t.type ? r(t).append(L) : r(t).replaceWith(L), r(h.controls).on("click", "li", (function(e) {
					var t = e.target,
						n = r(t).closest("li");
					O.stopIndex = void 0, N(n), O.save.call(O)
				}));
				var T = function(t, n) {
						void 0 === n && (n = !1);
						var o = {};
						...
						u && (o.style = u[1]), n && setTimeout((function() {
							return document.dispatchEvent(f.a.fieldAdded)
						}), 10), e.onAddField(b.lastID, o), Y(o, n), h.stage.classList.remove("empty")
					},
					D = function(t) {
						var n, o;
						(t = O.getData(t)) && t.length ? (t.forEach((function(e) {
							return T(Object(p.z)(e))
						...
						}, e.prepend && !r(".disabled-field.form-prepend", h.stage).length && (n.push(!0), C.prepend(o("prepend"))), e.append && !r(".disabled-field.form-.append", h.stage).length && (n.push(!0), C.append(o("append"))), O.disabledTT(h.stage), n.some((function(e) {
							return !0 === e
						})) && h.stage.classList.remove("empty"), O.save()
					},
					B = function(e) {
						var t, r = e.type,
							n = e.values,
							o = e.name,
							i = [j("a", c.a.get("addOption"), {
								className: "add add-opt"
							})],
							a = [j("label", c.a.get("selectOptions"), {
						...
						if(n && n.length) t = n.map((function(e) {
							...
							var u = (t = s.map((function(e) {
								return t = "" + c.a.get("optionCount", e), n = {
									label: t,
									value: Object(p.m)(t)
						...
						var r, n = t.type,
							...
							a = {
								...
								access: function() {
									...
									for(r in e.roles)
										if(e.roles.hasOwnProperty(r)) {
											...
											s.includes(r) && (i.checked = "checked"), n.push('<label for="' + o + '">'), n.push(O.input(i).outerHTML), n.push(" " + e.roles[r] + "</label>")
										}
									n.push("</div>");
									var a = {
										first: c.a.get("roles"),
								...
								multiple: function() {
									...
									return P("multiple", t, e[n] || e.default)
								}
							},
								...
								var r = [],
									n = {
										...
										boolean: function(e, r) {
											var n, o = !1;
											return t.hasOwnProperty(e) ? o = t[e] : (r.hasOwnProperty("value") || r.hasOwnProperty("value")) && (o = r.value || r.checked || !1), P(e, function(e) {
												for(var t = 1; t < arguments.length; t++) {
													var r = null != arguments[t] ? arguments[t] : {};
				...
				function I(e, t) {
					var r = t.multiple,
						...
						f = Object.keys(n).map((function(e) {
							...
							return(Array.isArray(i) ? i.includes(e) : e === i) && (t.selected = null), j("option", o, t)
						})),
						d = {
							id: e + "-" + b.lastID,
					...
					return Object.keys(u).forEach((function(e) {
						d[e] = u[e]
					})), '<div class="form-group ' + e + '-wrap">' + p + ('<div class="input-wrap">' + j("select", f, d).outerHTML + "</div>") + "</div>"
				}
				var P = function(e, t, r) {
						...
						t[e] && (o.checked = !0);
						var i = [],
							a = [j("input", null, o).outerHTML];
						return r.first && i.push(n(r.first)), r.second && a.push(" ", n(r.second)), r.content && a.push(r.content), a = j("div", a, {
							className: "input-wrap"
						}).outerHTML, j("div", i.concat(a), {
					...
					z = function(e) {
						...
						return t += O.input({
							...
							e === r && n.push("selected");
							var o = j("button", c.a.get("styles.btn." + r), {
								value: r,
								type: "button",
								className: n.join(" ")
							}).outerHTML;
					...
					U = function(e, t) {
						var r = t.class,
							n = t.className,
							o = t.value,
							i = w(t, ["class", "className", "value"])[e] || o,
							a = c.a.get(e) || e,
							l = {
								type: "number",
								value: i,
							...
							s = O.input(Object(p.z)(l)).outerHTML;
						return j("div", ['<label for="' + l.id + '">' + a + "</label>", '<div class="input-wrap">' + s + "</div>"], {
							className: "form-group " + e + "-wrap"
						}).outerHTML
					},
					H = function(e, t, r) {
						var n = r.map((function(r, n) {
								...
								return r.value === t[e] && (o.selected = !0), o = Object(p.z)(o), j("option", o.label, o)
							})),
							o = {
								id: e + "-" + b.lastID,
								name: e,
					...
					Q = function(t, r, n) {
						...
						var o = r[t] || "",
							i = c.a.get(t);
						"label" === t && (["paragraph"].includes(r.type) ? i = c.a.get("content") : o = Object(p.t)(o));
						...
						if(![].some((function(e) {
							...
							"label" !== t || e.disableHTMLLabels ? (s.value = o, s.type = "text", l += "<input " + Object(p.b)(s) + ">") : (s.contenteditable = !0, l += j("div", o, s).outerHTML);
							var f = '<div class="input-wrap">' + l + "</div>",
								d = n ? "none" : "block";
							"value" === t && (d = r.subtype && "quill" === r.subtype && "none"), l = j("div", [u, f], {
					...
					Y = function(t, n) {
						void 0 === n && (n = !0), b.lastID = O.incrementId(b.lastID);
						var i = t.type || "text",
						...
						f.push(j("span", "?", d)), f.push(j("div", "", {
							className: "prev-holder"
						}));
						var m = j("div", [R(t), j("a", c.a.get("close"), {
						...
						y.data("fieldData", {
							attrs: t
						}), void 0 !== O.stopIndex ? r("> li", h.stage).eq(O.stopIndex).before(y) : C.append(y), r(".sortable-options", y).sortable({
							update: function() {
								return O.updatePreview(y)
							}
						}), O.updatePreview(y), e.typeUserEvents[i] && e.typeUserEvents[i].onadd && e.typeUserEvents[i].onadd(v), n && (e.editOnAdd && (O.closeAllEdit(), O.toggleEdit(b.lastID, !1)), v.scrollIntoView && e.scrollToFieldOnAdd && v.scrollIntoView({
							behavior: "smooth"
						}))
					},
					W = function(e, t, r) {
						...
						for(var a = o.length - 1; a >= 0; a--) {
							...
							if(t.hasOwnProperty(l)) {
								...
								s.placeholder = c.a.get("placeholder." + l) || "", "selected" === l && !0 === t.selected && (s.checked = t.selected), i.push(j("input", null, s))
							}
						}
						var u = {
						...
						return i.push(j("a", null, u)), j("li", i).outerHTML
					},
					J = [".form-elements input", ".form-elements select", ".form-elements textarea"].join(", ");
				C.on("change blur keyup click", J, i()((function(e) {
					if(e) {
						if([function(e) {
								var t = e.type,
									r = e.target;
						...
						O.updatePreview(r(e.target).closest(".form-field")), O.save.call(O)
					}
				}), 333, {
					leading: !1
					...
					t.preventDefault(), o.querySelector(".sortable-options").childNodes.length <= 2 && !i.includes("checkbox") ? e.notify.error("Error: " + c.a.get("minOptionMessage")) : a.slideUp("250", (function() {
						a.remove(), O.updatePreview(n), O.save.call(O)
					}))
				...
				if(C.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), (function(e) {
						...
						e.target.value = Object(p.w)(e.target.value), "" === e.target.value ? r(e.target).addClass("field-error").attr("placeholder", c.a.get("cannotBeEmpty")) : r(e.target).removeClass("field-error")
					})), C.on("blur", "input.fld-maxlength", (function(e) {
						e.target.value = Object(p.j)(e.target.value)
					})), C.on("click touchstart", ".icon-copy", (function(t) {
						t.preventDefault();
						var n = r(t.target).parent().parent("li"),
							o = function(t) {
								b.lastID = O.incrementId(b.lastID);
								var n = t.attr("id"),
									o = t.attr("type"),
						...
						o.insertAfter(n), O.updatePreview(o), O.save.call(O)
						...
						if(document.addEventListener("modalClosed", (function() {
							...
							var s = j("h3", c.a.get("warning")),
								u = j("p", c.a.get("fieldRemoveWarning"));
							O.confirm([s, u], (function() {
								return O.removeField(a)
							}), i), l.addClass("deleting")
						} else O.removeField(a)
					})), C.on("click", ".style-wrap button", (function(e) {
						var t = r(e.target),
							n = t.closest(".form-elements"),
							o = t.val(),
							i = r(".btn-style", n);
						i.val(o), t.siblings(".btn").removeClass("selected"), t.addClass("selected"), O.updatePreview(i.closest(".form-field")), O.save()
						...
						r(".sortable-options", t).append(W(a, !1, i))
					...
					var Z = document.getElementsByClassName("formBuilder-injected-style");
					Object(p.i)(Z, (function(e) {
						return Object(a.f)(Z[e])
					}))
				}
				return document.dispatchEvent(f.a.loaded), o.actions = {
					...
					clearFields: function(e) {
						return O.removeAllFields(h.stage, e)
					},
					showData: O.showData.bind(O),
					save: O.save.bind(O),
					addField: function(e, t) {
						O.stopIndex = b.formData.length ? t : void 0, T(e)
					},
					removeField: O.removeField.bind(O),
					getData: O.getFormData.bind(O),
					setData: function(e) {
						O.stopIndex = void 0, O.removeAllFields(h.stage, !1), D(e)
					},
					setLang: function(e) {
						c.a.setCurrent.call(c.a, e).then((function() {
							h.stage.dataset.content = c.a.get("getStarted"), k.init(), h.empty(h.formActions), O.formActionButtons().forEach((function(e) {
					...
					toggleFieldEdit: function(e) {
						(Array.isArray(e) ? e : [e]).forEach((function(e) {
							["number", "string"].includes(typeof e) && ("number" == typeof e ? e = h.stage.children[e].id : /^frmb-/.test(e) || (e = h.stage.querySelector(e).id), O.toggleEdit(e))
						}))
					},
					toggleAllFieldEdit: function() {
						Object(p.i)(h.stage.children, (function(e) {
							O.toggleEdit(h.stage.children[e].id)
						}))
					},
					closeAllFieldEdit: O.closeAllEdit.bind(O),
					getCurrentFieldId: function() {
						return b.lastID
					}
				}, h.onRender(h.controls, (function() {
					setTimeout((function() {
						h.stage.style.minHeight = h.controls.clientHeight + "px", e.stickyControls.enable && O.stickyControls(C)
					}), 0)
				})), o
			},
			j = {
				init: function(e, t) {
					...
					return j.instance = {
						...
						get formData() {
							return j.instance.actions.getData && j.instance.actions.getData("json")
						},
						promise: new Promise((function(e, r) {
							c.a.init(i).then((function() {
								t.each((function(e) {
									var r = new O(o, t[e], jQuery);
									jQuery(t[e]).data("formBuilder", r), Object.assign(j, r.actions), j.instance.actions = r.actions
								})), delete j.instance.promise, e(j.instance)
							})).catch((function(e) {
