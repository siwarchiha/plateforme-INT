! function(o) {
	function t(i) {
		...
		return o[i].call(e.exports, e, e.exports, t), e.l = !0, e.exports
	}
	var l = {};
	t.m = o, t.c = l, t.i = function(o) {
		return o
	}, t.d = function(o, l, i) {
	...
	}, t.p = "/assets/js/control_plugins", t(t.s = 1)
}([, function() {
	"use strict";
			...
			h = function(e) {
				...
				return l(s, e), s.prototype.configure = function() {
					...
					$.extend(!0, $.trumbowyg.langs.en, {
						...
						o.input.value = l.trumbowyg("html")
					}).trumbowyg("html", t)
				}, i(s, null, [{
					key: "definition",
					get: function() {
